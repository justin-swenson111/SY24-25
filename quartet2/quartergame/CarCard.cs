...
namespace Quartet
{
    internal class CarCard
    {
        ...
        public CarCard(string id, string name, int maxspeed, double zerotosixty, int hp, int cc, int cylinders, int rpm, string pic)
        {
            this.id = id.ToUpper();
            this.name = name;
        ...
        public CarCard Compare(CarCard other, category c)
        {
            ...
            if (c == category.maxspeed)
                if (maxspeed > other.maxspeed)
                    return this;
                else if (maxspeed < other.maxspeed)
                    return other;
        ...
        public CarCard CompareLow(CarCard other, category c)
        {
            if (other == null) return this;
            //maxspeed
            if (c == category.maxspeed)
